    ...
    $.fn.extend({
        ...
        venobox: function(options) {
            ...
            var defaults = {
                ...
                overlayClose: true, // disable overlay click-close - thanx
									// @martybalandis
                overlayColor : 'rgba(23,23,23,0.85)',
                spinner : 'double-bounce', // available: 'rotating-plane' |
											// 'double-bounce' | 'wave' |
											// 'wandering-cubes' |
											// 'spinner-pulse' | 'chasing-dots'
											// | 'three-bounce' | 'circle' |
											// 'cube-grid' | 'fading-circle' |
											// 'folding-cube'
                spinColor : '#d2d2d2',
                titleattr: 'title', // specific attribute to get a title (e.g.
									// [data-title]) - thanx @mendezcode
                titleBackground: '#161617',
                titleColor: '#d2d2d2',
                titlePosition : 'top', // 'top' || 'bottom'
                share: [], // ['facebook', 'twitter', 'linkedin', 'pinterest',
							// 'download']
                cb_pre_open: function(){ return true; }, // Callbacks - thanx
															// @garyee
            ...
            return this.each(function() {
                ...
                function loadIframe(){
                  ...
                  // $('.venoframe').load(function(){ // valid only for
					// iFrames in same domain
                    updateoverlay();
                  // });
                }
                ...
                function loadVid(autoplay){
                    ...
                    // set rel=0 to hide related videos at the end of YT +
					// optional autoplay
